...
export const BleManagerContextProvider = ({ children }: BleManagerContextProviderProps) => {
    ...
    }, [connectedDevicesInfo.find(deviceInfo => deviceInfo.index === 1)?.notifyCharacteristicUUID,connectedDevicesInfo.find(deviceInfo => deviceInfo.index === 1)?.notifyCharacteristicUUID]);

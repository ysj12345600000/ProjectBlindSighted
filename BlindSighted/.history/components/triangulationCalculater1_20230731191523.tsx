...
export const triangulationCalculater = () => {
    ...
    // 非线性优化获取用户位置
    function triangulationOptimization(connectDevicesInfoList: connectDevicesInfoList[]) {
    ...
    const angleDifference = async (connectDevicesInfoList : DsitanceCalculateParams[], userPosition: {x:number, y:number}) => {

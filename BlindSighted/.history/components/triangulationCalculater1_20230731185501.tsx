...
import { ConnectedDeciceInfo, import { useBleManager, BleManagerContextProvider } from './components/BleOperation1'; } from '../components/BleOperation1';
...
export const triangulationCalculater = () => {
    ...
    const calculateDistance = async (distanceCalculateParamsList : DsitanceCalculateParams[], rssiList: ): number => {

...
export const BleManagerContextProvider = ({ children }: BleManagerContextProviderProps) => {
    ...
    }, [currentCommunicatrMacIdconnectedDevicesInfo.find(deviceInfo => deviceInfo.index === 1)?.notifyCharacteristicUUID,connectedDevicesInfo.find(deviceInfo => deviceInfo.index === 1)?.writeCharacteristicUUID]);

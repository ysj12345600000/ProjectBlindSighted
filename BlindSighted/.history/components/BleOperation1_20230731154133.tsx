...
export const BleManagerContextProvider = ({ children }: BleManagerContextProviderProps) => {
    ...
    const [connectedDevicesInfo, setConnectedDevicesInfo] = useState<ConnectedDeciceInfo[]|undefined>(new Array(3));
    ...
    const connectBle = async (macId:string) => {
        ...
        if(connectedDevicesInfo.every(item => item === undefined))

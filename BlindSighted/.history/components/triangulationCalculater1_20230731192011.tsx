...
export const triangulationCalculater = () => {
    ...
    const angleDifference = async (connectDevicesInfoList : ConnectedDeciceInfo[], userPosition: {x:number, y:number}) => {
        ...
        const angleN = computeN(targetDeviceParams2[0].distanceCalculateParams!.position[0], targetDeviceParams2[0].distanceCalculateParams!.position[1], targetDeviceParams1[0].distanceCalculateParamsangle);//计算AN向量极坐标角度(A为设备1)

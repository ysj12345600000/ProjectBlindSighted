        ...
        try{
            ...
            setConnectedDevicesInfo(prevDevices => prevDevices.map(deviceInfo=>{
                if(deviceInfo.device.id === macId){
                    return {
                        ...deviceInfo,
                    deviceInfo.notifyCharacteristicUUID = characteristics[0].uuid;
                    deviceInfo.writeCharacteristicUUID = characteristics[1].uuid;
                    deviceInfo.serviceId = characteristics[1].uuid;
                }
                return deviceInfo;
            }

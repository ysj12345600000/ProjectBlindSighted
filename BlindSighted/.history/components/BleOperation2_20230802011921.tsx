...
export const BleManagerContextProvider = ({ children }: BleManagerContextProviderProps) => {
    ...
    const addRssiToList = (index: number, DeviceForRssi:Device) => {
        ...
        const promises = setRssiLists(prevRssiLists => prevRssiLists.map(rssiInfo=>{
    ...
    const notiy=() => {
        ...
        console.log('rssiLists', rssiLists);
        console.log('connectedDevicesNumber', connectedDevicesNumber);
    };

...
import { useBleManager, BleManagerContextProvider, ConnectedDeciceInfo } from './components/BleOperation1';
 ...
 */
  ...
  const calculateDistancePositionAngle = async ( deviceInfoList : ConnectedDeciceInfo[], rssiList : Rssi) => {
    const updateDeviceInfo = await calculateDistances(deviceInfoList);

 ...
 */
  ...
  const calculateDistancePositionAngle = async ( deviceInfoList : ConnectedDeciceInfo[], rssiList : RssiInfo) => {
    const updateDeviceInfo = await calculateDistances(deviceInfoList, rssiList.rssiList);

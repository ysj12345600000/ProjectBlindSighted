...
const ContextApp = () => {
  ...
  const intervalRef = useRef(null); // 用于定时器
  ...
  useEffect(() => {
    ...
    intervalRef.current = setInterval(fetchAngleAndPosition, INTERVAL_TIME);
 ...
 */
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="获取角度" color='orange' onPress={testCampass} />
      <Text>用户坐标:{userAngle}</Text>
